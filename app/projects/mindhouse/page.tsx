      ...
      <article className="pt-16">
        <header className="bg-white pb-16 pt-20">
          <div className="max-w-4xl mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-semibold mb-4 text-gray-900">Re-Designing Live Class Filtering</h1>
        ...
        <main className="max-w-4xl mx-auto px-4 py-12 space-y-16">
          <section>
            ...
            <div className="max-w-2xl">
              ...
              <blockquote className="border-l-4 border-[#7E58EA] pl-6 py-4 my-6">
